...
/*
export const useAuthUrl = routeLoader$<string | null>(async () => {
...
export default component$(() => {
    ...
    const authUrl = `${import.meta.env.PUBLIC_API_URL}/auth/url`;
        ...
        <div class="min-h-screen bg-[#080810] text-white flex flex-col">
            ...
            <header class="sticky top-0 z-50 border-b border-white/8 bg-[#080810]/80 backdrop-blur-md">
                <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center font-bold text-sm shadow-lg shadow-indigo-500/30">
                            S
                        </div>
                    ...
                    <div class="flex items-center gap-3">
                        {authUrl ? (
                            <a
                                href={authUrl}
                                class="flex items-center gap-2 bg-[#5865F2] hover:bg-[#4752c4] text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-all shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40 hover:-translate-y-0.5"
                            >
                            ...
                            <Link
                                href="/dashboard"
                                class="bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-all hover:-translate-y-0.5"
                            >
                                Dashboard
                            </Link>
                        )}
            ...
            <section class="flex-1 flex flex-col items-center justify-center text-center px-6 py-28 relative overflow-hidden">
                ...
                <div class="absolute inset-0 pointer-events-none">
                    ...
                    <div class="absolute top-1/3 left-1/3 w-[300px] h-[300px] bg-purple-600/8 rounded-full blur-2xl" />
                </div>
              ...
              des médias
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 mt-4">
                        {authUrl ? (
                            <a
                                href={`${import.meta.env.PUBLIC_API_URL}/auth/url`}
                                class="flex items-center justify-center gap-3 bg-[#5865F2] hover:bg-[#4752c4] text-white font-bold px-8 py-4 rounded-2xl transition-all text-lg shadow-2xl shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:-translate-y-1"
                            >
                            ...
                            <Link
                                href="/dashboard"
                                class="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-bold px-8 py-4 rounded-2xl transition-all text-lg hover:-translate-y-1"
                            >
                        ...
                        <a
                            href="#how-it-works"
                            class="flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-semibold px-8 py-4 rounded-2xl transition-all text-lg hover:-translate-y-1"
                        >
                        ...
                        <div class="bg-[#0f0f18] rounded-xl p-6 flex flex-col gap-3">
                            ...
                            {[
                                ...
                                <div key={row.user} class="flex items-center gap-3 bg-white/3 border border-white/5 rounded-lg px-4 py-3 text-sm">
                                    <div class="w-6 h-6 rounded-full bg-indigo-600/40 flex items-center justify-center text-xs font-bold shrink-0">
                ...
                <div class="max-w-5xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            {
                                step: "01",
                                title: "Créez votre room",
                                desc: "Connectez-vous avec Discord, créez une room liée à votre serveur. Vous obtenez une URL unique pour votre overlay.",
                                icon: "🏠",
                            ...
                            {
                                step: "02",
                                title: "Ajoutez dans OBS",
                                desc: "Copiez l'URL overlay depuis votre dashboard et ajoutez-la comme Source Navigateur dans OBS ou Streamlabs. Fond transparent inclus.",
                                icon: "🎬",
                            ...
                            {
                                step: "03",
                                title: "Vos viewers envoient",
                                desc: "Les membres de votre serveur Discord utilisent /image, /video ou /url. Les médias s'affichent en temps réel sur votre stream !",
                                icon: "⚡",
            ...
            <section id="rules" class="py-24 px-6 border-t border-white/5">
                <div class="max-w-3xl mx-auto">
                    <div class="text-center mb-12">
                        ...
                        <p class="text-white/40 mt-4">Le streamer est responsable de ce qui s'affiche sur son stream. Ces règles s'appliquent à tous les membres.</p>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        {[
                            ...
                            { icon: "🚫", rule: "Pas de spam", desc: "Envoyer des médias en masse pour saturer la file d'attente est interdit et peut entraîner un bannissement." },
            ...
            {/* ── CTA FINAL ── */}
            <section class="py-24 px-6 border-t border-white/5 text-center relative overflow-hidden">
                <div class="absolute inset-0 pointer-events-none">
                    <div class="absolute bottom-0 left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-indigo-600/8 rounded-full blur-3xl" />
                </div>
            ...
            <footer class="border-t border-white/8 px-6 py-10">
                <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div class="text-white/20 text-xs">
                        © 2026 StreamOverlay — Fait avec ❤️ pour les streamers
                    </div>
                </div>
            </footer>
        </div>
